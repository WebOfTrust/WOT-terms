...
// Config
const url = 'https://trustoverip.github.io/tswg-cesr-specification/index.html';
const organisation = 'TSWG (CESR)';
const jsonFileName = 'terms-definitions-tswg-cesr.json';
