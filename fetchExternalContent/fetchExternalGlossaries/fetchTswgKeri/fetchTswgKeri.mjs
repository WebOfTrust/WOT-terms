...
// Config
const url = 'https://trustoverip.github.io/tswg-keri-specification/index.html';
const organisation = 'TSWG (Keri)';
const jsonFileName = 'terms-definitions-tswg-keri.json';
