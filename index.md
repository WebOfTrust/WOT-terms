...
The YAML syntax depends on exact spacing, so make sure you follow the pattern shown in the sample sidebars. See my [YAML tutorial](term_mydoc_yaml_tutorial) for more details about how YAML works.
