...
Validator and [verifier](term_verifier) are close to synonyms for our purposes.
...
During validation of virtual credentials for example, a [verifier](term_verifier) checks to see if a verifiable [credential](term_credential) ([VC](term_VC)) has been signed by the controller of this VC using the applicable verification method.
