...
In cryptography, a web of trust is a concept used in [PGP](term_pgp), [GnuPG](term_gig), and other `OpenPGP`-compatible systems to establish the authenticity of the binding between a public key and its owner.\
